...
const mobileGroups = [
  ...
  },
  {
    ...
    items: megaSections.filter((item) => ["/prime-video", "/anime-moments"].includes(item.to)),
          ...
          <div className="relative">
            <div className="nav-theme-shell nav-bar-shell flex min-h-[56px] items-center gap-2 rounded-[1.35rem] px-3 py-2 sm:min-h-[64px] sm:px-4 lg:px-5 xl:px-6">
              ...
              <div className="ml-auto hidden items-center gap-2 md:flex">
                ...
                >
                  <span key={`desktop-cta-${rotatingCta.to}-${menuRotationIndex}`} className="inline-flex items-center gap-2 animate-in fade-in zoom-in-95 duration-500 neon-rgb-text-mini text-xs">
                    {rotatingCta.label}
