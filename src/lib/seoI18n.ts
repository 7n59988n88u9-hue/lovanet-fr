...
const ROUTE_DESCRIPTIONS: Record<RouteKey, string> = {
  ...
  "/univers": "Monde Lovanet : entrée rapide vers les vidéos, le magasin, le catalogue, les actus et les services du compte.",
  "/shop": "Magasin Lovanet : posters, collectors, vêtements et produits manga, avec accès panier et parcours client.",
  "/anime-catalog": "Sélection anime Lovanet : fiches, trailers et recherche de titres pour explorer les séries et films.",
  "/anime-countdown": "Anime prochainement : calendrier et compte à rebours des prochaines sorties d'épisodes et de saisons.",
  "/prime-video": "Cinéma Lovanet : sélection d'anime, lecture continue et recommandations par univers.",
...
const TITLES: Record<Locale, Record<RouteKey, string>> = {
  fr: {
    ...
    "/univers": "Monde Lovanet : vidéos, shorts, catalogue anime et magasin",
    ...
    "/prime-video": "Cinéma : Lovanet streaming",
  ...
  en: {
    ...
    "/univers": "Lovanet World : anime videos, shorts, catalog and shop",
  ...
  es: {
    ...
    "/univers": "Mundo Lovanet : vídeos anime, shorts, catálogo y tienda",
  ...
  de: {
    ...
    "/univers": "Lovanet-Welt : Anime-Videos, Shorts, Katalog und Shop",
  ...
  it: {
    ...
    "/univers": "Mundo Lovanet : video anime, shorts, catalogo e shop",
  ...
  pt: {
    ...
    "/anime-moments": "Lovanet : página oficial Lovanet",
    "/univers": "Mundo Lovanet : vídeos anime, shorts, catálogo e loja",
  ...
  zh: {
    ...
    "/prime-video": "Cinéma : Lovanet 流媒体",
